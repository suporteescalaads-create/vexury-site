...
export const Hero: React.FC = () => {
  ...
  return (
    <section ref={containerRef} className="hero-section relative pt-24 md:pt-32 pb-0 overflow-hidden bg-[#03000a]">
      ...
      <div className="container mx-auto px-6 text-center relative z-20 flex flex-col items-center">
        ...
        <div className="max-w-4xl">
            <div className="inline-flex items-center gap-2 px-6 py-2 rounded-full bg-white/5 border border-white/10 text-accent-light text-sm font-medium mb-8 md:mb-10 shadow-[0_0_20px_rgba(168,85,247,0.2)]">
            ...
            <div className="mb-8 md:mb-12">
                ...
                >
                    <button className="px-10 md:px-12 py-4 md:py-5 bg-white text-black rounded-full font-bold transition-all duration-300 shadow-[0_0_20px_rgba(255,255,255,0.2)] flex items-center gap-2 group relative overflow-hidden active:scale-95">
        ...
        {/* Hero Image - Ajustada altura mínima para Mobile */}
        <motion.div 
          style={{ scale }}
          className="image-container relative z-20 flex justify-center items-end w-full"
        >
            <div className="relative w-full flex justify-center items-end min-h-[150px] md:min-h-[300px]">
                ...
                <img 
                    ...
                    className="w-full h-auto max-w-[1200px] object-contain block mb-[-1px] drop-shadow-[0_-10px_30px_rgba(168,85,247,0.1)]"
                    loading="eager"
                    fetchpriority="high"
                    width="1200"
                    height="600"
