...
const RadarVisual = () => (
    <div className="relative w-full h-full flex items-center justify-center">
        {/* Scanning Line - Increased Opacity for Neon look */}
        <motion.div 
            animate={{ rotate: 360 }}
...
export const Work: React.FC = () => {
  ...
  return (
    <section id="process" className="py-24 bg-[#03000a] relative overflow-hidden">
      {/* Cinematic Background - Darker deeper Purple */}
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_50%,_rgba(88,28,135,0.1),transparent_80%)]" />
      ...
      <div className="container mx-auto px-6 md:px-12 lg:px-20 relative z-10 max-w-7xl">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-32 items-center">
            ...
            {/* RIGHT: Holographic Core - DARKER NEON BACKGROUND */}
            <div className="relative h-[600px] w-full flex items-center justify-center">
                
                {/* Background Reactor Ring - Darker and more defined */}
                <div className="absolute inset-0 border-2 border-white/10 rounded-[4rem] bg-[#020105] shadow-[0_40px_100px_rgba(0,0,0,0.8)]" />
                
                {/* Internal Deep Glow */}
                <div className="absolute inset-8 rounded-[3rem] bg-gradient-to-b from-accent/5 via-black to-black shadow-inner" />
                
                {/* Grainy Texture Overlay */}
                <div className="absolute inset-4 border border-white/5 rounded-[3.5rem] bg-[url('https://grainy-gradients.vercel.app/noise.svg')] opacity-[0.15] pointer-events-none" />
                
                {/* The Stage */}
                <div className="relative w-full h-full flex items-center justify-center p-16 overflow-hidden">
                    {/* Pulsing Light from within the core */}
                    <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-4/5 h-4/5 bg-accent/5 rounded-full blur-[100px] pointer-events-none animate-pulse-slow" />
