...
export const Hero: React.FC = () => {
  ...
  // Scroll Physics - GPU accelerated parallax
      ...
      <div className="absolute inset-0 w-full h-full overflow-hidden z-0 pointer-events-none">
          ...
          />
           ...
           <motion.div
            ...
            className="absolute bottom-1/4 right-1/4 w-[500px] h-[500px] bg-blue-600 rounded-full blur-[150px] mix-blend-screen opacity-15"
          />
